...
def parse_args():
    ...
    model_grp.add_argument("--model", choices=list(MODEL_PRESETS.keys()),
                           help="Model preset (vit / siglip)")
    model_grp.add_argument("--model_name", help="Any HuggingFace vision model ID")
    ...
    p.add_argument("--target_modules", nargs="+", default=None,
                   help="Adapter target layer names (auto-detected if omitted)")
