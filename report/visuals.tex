...
Table~\ref{tab:glue-results} is a template for reporting results on the selected GLUE tasks: SST-2, QQP, and MRPC. The comparison is between LoRA-trained and DoRA-trained models for three model families: LLaMA small, LLaMA big, and RoBERTa. This layout follows the paper's style more closely by using model-method pairs as rows and benchmark metrics as columns. The values below are sample data only.

\begin{table}[h]
\centering
\caption{GLUE benchmark comparison between LoRA and DoRA. Replace placeholder values with final validation or test results. The Avg. column should summarize the task-level results for each model-method pair.}
\label{tab:glue-results}
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{llcccccc}
\toprule
\textbf{Model} & \textbf{Method} & \textbf{SST-2 Acc.} & \textbf{QQP Acc.} & \textbf{QQP F1} & \textbf{MRPC Acc.} & \textbf{MRPC F1} & \textbf{Avg.} \\
\midrule
\multirow{2}{*}{LLaMA Small}
  & LoRA & 90.8 & 88.1 & 84.6 & 82.4 & 86.5 & 86.5 \\
  & DoRA & 91.9 & 89.0 & 85.8 & 84.1 & 87.9 & 87.7 \\
\midrule
\multirow{2}{*}{LLaMA Big}
  & LoRA & 93.1 & 89.7 & 86.7 & 84.8 & 88.5 & 88.6 \\
  & DoRA & 94.0 & 90.5 & 87.6 & 86.0 & 89.6 & 89.5 \\
\midrule
\multirow{2}{*}{RoBERTa}
  & LoRA & 95.0 & 90.8 & 88.0 & 87.1 & 90.4 & 90.3 \\
  & DoRA & 95.3 & 91.2 & 88.5 & 87.8 & 91.0 & 90.8 \\
\bottomrule
\end{tabular}
\end{table}
...
Figures~\ref{fig:heatmap}--\ref{fig:learning-curve} show report-ready visualizations based on the same sample data. Replace the sample CSV values later and regenerate the figures.
...
\begin{axis}[
    ...
    ymin=0.5, ymax=3.5,
    xtick={1,2,3,4,5},
    xticklabels={SST-2, QQP Acc., QQP F1, MRPC Acc., MRPC F1},
    ytick={1,2,3},
    yticklabels={RoBERTa, LLaMA Big, LLaMA Small},
    colormap/viridis,
    colorbar,
    point meta min=0.4,
    point meta max=1.7,
...
\addplot[
    ...
    (1,3) [1.1] (2,3) [0.9] (3,3) [1.2] (4,3) [1.7] (5,3) [1.4]
    (1,2) [0.9] (2,2) [0.8] (3,2) [0.9] (4,2) [1.2] (5,2) [1.1]
    (1,1) [0.3] (2,1) [0.4] (3,1) [0.5] (4,1) [0.7] (5,1) [0.6]
};
\end{axis}
\end{tikzpicture}
\caption{Heatmap of DoRA minus LoRA performance for each model and metric. Positive values indicate a gain from DoRA.}
\label{fig:heatmap}
\end{figure}
